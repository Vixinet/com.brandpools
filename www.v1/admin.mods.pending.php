<?php
	...
	$accounts = array();
	$p = getPagination("SELECT a.id, a.email, x.name FROM account_mod x  INNER JOIN account a ON a.id = x.account where validated=0  ORDER BY x.name");
	$stmt = $p['stmt'];
	$stmt->execute();
...
?>
	...
	<div class="panel panel-default">
		<ol class="breadcrumb" style="margin-bottom:0px">
			...
			<li><a href="admin.mods.list.php">Moderators</a></li>
