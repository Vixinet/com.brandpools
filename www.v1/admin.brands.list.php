<?php
	...
	$accounts = array();
	$p = getPagination("SELECT a.id, a.email, x.name  FROM account_brand x  INNER JOIN account a ON a.id = x.account WHERE a.validated = 1 ORDER BY x.name");
	$stmt = $p['stmt'];
	$stmt->execute();
...
?>
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<a href="admin.brands.pending.php" class="pull-left btn btn-default"><span class="glyphicon glyphicon-time"></span> Waiting for validation</a>
			<a href="admin.brand.create.php" class="pull-right btn btn-default"><span class="glyphicon glyphicon-plus"></span> New account</a>
		</div>
