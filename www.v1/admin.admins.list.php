<?php 
	...
	$accounts = array();
	$p = getPagination("SELECT a.id, a.email, x.name FROM account_admin x INNER JOIN account a ON a.id = x.account WHERE validated=1 ORDER BY id");
	$stmt = $p['stmt'];
	$stmt->execute();
...
?>
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<a href="admin.admins.pending.php" class="pull-left btn btn-default"><span class="glyphicon glyphicon-time"></span> Waiting for validation</a>
